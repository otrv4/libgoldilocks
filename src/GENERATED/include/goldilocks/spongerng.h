...
typedef struct {
    goldilocks_keccak_sponge_t sponge;  /**< Internal sponge object. */
} goldilocks_keccak_prng_s;

/** Keccak CSPRNG structure as one-element array */
typedef goldilocks_keccak_prng_s goldilocks_keccak_prng_t[1];

/** Initialize a sponge-based CSPRNG from a buffer. */
void goldilocks_spongerng_init_from_buffer (
    goldilocks_keccak_prng_t prng,             /**< [out] The PRNG object. */
...
goldilocks_spongerng_destroy (
    goldilocks_keccak_prng_t doomed /**< [in] The object to destroy. */
);
...
/***************************************/
void goldilocks_spongerng_destroy (goldilocks_keccak_prng_t doomed) {
